    ...
    if(searchText=='' && selectOption!=""){
      ...
      switch(selectOption){
        case optionType[0]://homestay name
          query = { homestayName: { $regex: searchText , $options: 'i'} }
          break
        case optionType[1]://Owner name
          query = {ownerName:{ $regex: searchText ,  $options: 'i'}}
          break
        case optionType[2]://Local Reg
          query = {registrationNumberDot:{ $regex: searchText , $options: 'i' }}
          break
        case optionType[3]://Local Reg
          query = {registrationLocal:{ $regex: searchText, $options: 'i' }}
          break
        case optionType[4]://Contact
          query = {contact:{ $regex: searchText, $options: 'i' }}
          break
      }
    }
