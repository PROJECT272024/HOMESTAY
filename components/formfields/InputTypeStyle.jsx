...
const InputTextStyle = ({id,name,value='',type='text',required='false',
  ...
  return (
    <div className="relative">
        ...
        <label htmlFor={id} className={`${readonly=='true'? 'bg-gray-100':'bg-white' }  absolute text-sm text-gray-500
